...
class Firewall (EventMixin):
    ...
    def _handle_ConnectionUp (self, event):
        ...
        for spoofmac, spoofvalues in self.patternTable.items():
    ...
    def addRuleToCSV(self, srcmac='any', srcip='any', dstip='any'):
        ...
        to_add = True
        for spoofmac, spoofvalues in self.currentlyBlocked.items():
    ...
    def verifyPortSecurity(self, packet, match=None, event=None):
        ...
        if packet.type == packet.IP_TYPE:
            ...
            if ip_packet.srcip == None or ip_packet.dstip == None:
                ...
                return True
            if packet.src not in self.patternTable:        # MAC address is not in the spoofing table. Checking IP address
                for spoofmac, spoofvalues in self.patternTable.items():
